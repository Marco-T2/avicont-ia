...
// ── System prompt ──
//
// Detección de inventarios por substring del nombre de cuenta — limitación v1:
// si el plan de cuentas usa términos no estándar (p. ej. "Bienes de cambio",
// "Stock", "Productos terminados" sin la palabra "Existencia"), la prueba
// ácida puede coincidir con la liquidez corriente porque inventarios = 0.
// v2 evaluará pasar a un campo dedicado en el JSON curado si el problema se
// vuelve recurrente.
