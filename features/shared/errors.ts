...
export const PAYMENT_CREDIT_MISMATCH = "PAYMENT_CREDIT_MISMATCH";
export const PAYMENT_DUPLICATE_CREDIT_SOURCE = "PAYMENT_DUPLICATE_CREDIT_SOURCE";
export const PAYMENT_CREDIT_SOURCE_NOT_FOUND = "PAYMENT_CREDIT_SOURCE_NOT_FOUND";
...
export const PAYMENT_CREDIT_CONSUMED_EXCEEDS_NEW_AMOUNT = "PAYMENT_CREDIT_CONSUMED_EXCEEDS_NEW_AMOUNT";
