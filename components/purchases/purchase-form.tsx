...
export default function PurchaseForm({
  ...
  // Período = derivado puro de la fecha (no seleccionable). El backend valida
  // invariante I12 (date ∈ período) en createDraft/post/update.
      ...
      <Card className={isVoided ? "opacity-70" : undefined}>
        ...
        <CardContent className="space-y-4">
          {isReadOnly && isEditMode ? (
            ...
            /* ── Editable form grid ── */
            <>
              {/* Row 1: Tipo / Nro Referencia / Fecha (con hint de período derivado) */}
