...
export default function PayableForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/organizations/${orgSlug}/cxp`, {
        method: "POST",
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error ?? "Error al crear la cuenta por pagar");
      }
      ...
      toast.error(
        err instanceof Error ? err.message : "Error al crear la cuenta por pagar",
      );
    } finally {
