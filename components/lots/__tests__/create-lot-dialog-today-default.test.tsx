 ...
 * RED → GREEN
 *
 * C-1 fix — create-lot-dialog.tsx startDate default uses todayLocal(),
...
describe("CreateLotDialog — startDate default (C-1)", () => {
  beforeAll(() => {
    vi.useFakeTimers();
  });
  ...
  it("C-1.a — at 21:00 BO (UTC next day) default startDate is LOCAL today, not UTC tomorrow", () => {
  ...
  it("C-1.b — at 15:00 BO (well before UTC midnight) default startDate is correct", () => {
