/**
 * Sentinel: decimal.js import-shape — iva-books/purchases/export/entity-to-dto (DEC-1 residual P2).
 *
...
describe("sentinel: decimal.js import-shape — iva-books/purchases/export/entity-to-dto (DEC-1 residual P2)", () => {
