...
//   `listPurchasesByPeriod` returning entity[] (mock empty array
//   satisface batch wrapper map identity sin mapper transform real).
// - legacy server mock preserva `exportIvaBookExcel` (XLSX exporter
//   no migrated) — split de mocks vs C1 single mock.
// Mirror simétrico sale export route test.
