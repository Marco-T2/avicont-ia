...
export default function Home() {
  return (
    <section className="min-h-full flex flex-col overflow-y-auto bg-gradient-to-b from-emerald-50 via-white to-white dark:from-emerald-950/40 dark:via-background dark:to-background">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:py-20 flex-1">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          {/* Left column — institutional content */}
          <div className="order-2 lg:order-1">
            <Badge className="mb-4 bg-emerald-100 text-emerald-800 uppercase tracking-widest text-[10px] font-semibold border-emerald-200 dark:bg-emerald-900/40 dark:text-emerald-200 dark:border-emerald-800/50">
              Asociación Avicola
            </Badge>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-emerald-900 dark:text-emerald-100 mb-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Card size="sm">
                <CardContent className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm text-foreground">Misión</p>
              ...
              <Card size="sm">
                <CardContent className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm text-foreground">Visión</p>
                    <p className="text-xs text-muted-foreground mt-1">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl ring-1 ring-emerald-200/60 dark:ring-emerald-800/40">
              <Image
                src="/farm.webp"
                alt="Granja Avícola"
                fill
