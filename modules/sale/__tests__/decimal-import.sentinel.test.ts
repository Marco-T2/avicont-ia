 ...
 * Cycle 1 / sale (sdd/oleada-money-decimal-hex-purity).
 *
 * Sister of sub-POC 2 Cycles 1-5 (FS, TB, ES, WS, IB). Asserts
 * `modules/sale/domain/build-sale-entry-lines.ts` no longer value-imports
 ...
 *
 * Declared failure mode (pre-GREEN): both assertions FAIL — build-sale-entry-lines.ts
...
describe("sentinel: decimal.js import-shape — sale/domain/build-sale-entry-lines (sub-POC 3 Cycle 1)", () => {
