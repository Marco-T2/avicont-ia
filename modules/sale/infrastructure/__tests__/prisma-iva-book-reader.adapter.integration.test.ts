 ...
 * fidelidad bit-exact). (Legacy `IvaBooksService` y `IvaBooksRepository`
 * deleted POC siguiente A2-C3, engram `poc-siguiente/a2/c3/closed` —
 * adapter Prisma directo permanece como implementación final hex.)
 */
