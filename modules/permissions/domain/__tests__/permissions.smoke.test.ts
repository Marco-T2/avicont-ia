...
describe("permissions.server.ts — async facades now server-only", () => {
  it("canAccess is exported and callable", async () => {
    const mod = await import("@/modules/permissions/application/permissions.server");
  ...
  it("canAccess returns a Promise (async 4-param signature)", async () => {
    ...
    const { canAccess } = await import("@/modules/permissions/application/permissions.server");
  ...
  it("canPost returns a Promise (async 3-param signature)", async () => {
    const { canPost } = await import("@/modules/permissions/application/permissions.server");
