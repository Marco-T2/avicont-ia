...
export const JOURNAL_DATE_OUTSIDE_PERIOD = "JOURNAL_DATE_OUTSIDE_PERIOD";
export const SALE_DATE_OUTSIDE_PERIOD = "SALE_DATE_OUTSIDE_PERIOD";
export const PURCHASE_DATE_OUTSIDE_PERIOD = "PURCHASE_DATE_OUTSIDE_PERIOD";
export const PAYMENT_DATE_OUTSIDE_PERIOD = "PAYMENT_DATE_OUTSIDE_PERIOD";
export const DISPATCH_DATE_OUTSIDE_PERIOD = "DISPATCH_DATE_OUTSIDE_PERIOD";
...
export const PURCHASE_CONTACT_INACTIVE = "PURCHASE_CONTACT_INACTIVE";
export const PURCHASE_ACCOUNT_NOT_FOUND = "PURCHASE_ACCOUNT_NOT_FOUND";
...
export const SALE_CONTACT_INACTIVE = "SALE_CONTACT_INACTIVE";

// Cierre Mensual / Bloqueado
export const LEGACY_CLOSE_REMOVED = "LEGACY_CLOSE_REMOVED"; // 410 — legacy PATCH /periods/:id close endpoint
