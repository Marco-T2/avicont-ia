 ...
 * desacoplado del legacy `IvaBooksService` (legacy class deleted POC siguiente
 * A2-C3, engram `poc-siguiente/a2/c3/closed`), NO como endorsement de
 * acoplamiento bidireccional. Retirado en POC #11.0c cuando IVA-hex se
 * suscriba a un purchase event o lea de un projected snapshot. Adapter ahora
 * wraps el hex `IvaBookService` (post-A2-C3 cutover hex factory
 * `makeIvaBookService`).
 *
