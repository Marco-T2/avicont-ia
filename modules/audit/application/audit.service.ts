...
import { classify } from "../domain/audit.classifier";
import type {
  AuditCursor,
  AuditEntityType,
  AuditEvent,
...
/** Port for resolving user display names from changedById set. */
...
export class AuditService {
  constructor(
    ...
    private readonly userResolver: UserNameResolver,
  ) {}
  ...
  private async resolveUserNames(rows: AuditRow[]): Promise<Map<string, string>> {
    ...
    return this.userResolver.resolveNames(ids);
  }
}
