 ...
 * Cycle 3 / ES (sdd/oleada-money-decimal-hex-purity).
 *
 * Sister of sub-POC 2 Cycles 1-2 (FS, TB). Asserts
 * `modules/accounting/equity-statement/domain/equity-statement.builder.ts` no
 ...
 *
 * Declared failure mode (pre-GREEN): both assertions FAIL — equity-statement.builder.ts
...
describe("sentinel: decimal.js import-shape — equity-statement/domain/equity-statement.builder (sub-POC 2 Cycle 3)", () => {
