 ...
 * Cycle 4 / WS (sdd/oleada-money-decimal-hex-purity).
 *
 * Sister of sub-POC 2 Cycles 1-3 (FS, TB, ES). Asserts
 * `modules/accounting/worksheet/domain/worksheet.builder.ts` no longer
 ...
 *
 * Declared failure mode (pre-GREEN): both assertions FAIL — worksheet.builder.ts
...
describe("sentinel: decimal.js import-shape — worksheet/domain/worksheet.builder (sub-POC 2 Cycle 4)", () => {
