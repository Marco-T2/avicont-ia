...
describe("Block 5 — REQ-009 FINAL + REQ-010 carry-forward", () => {
  ...
  it("α117: modules/accounting/worksheet/infrastructure/exporters/worksheet-pdf.exporter.ts imports from @/modules/accounting/financial-statements/infrastructure/exporters (REQ-010 POSITIVE — tech debt tolerated, carry-forward to sub-POC 6)", () => {
