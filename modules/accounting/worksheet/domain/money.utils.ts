/**
 * Pure money math utilities for Worksheet.
 *
 ...
 * `sumDecimals` + `eq`. 4th copy total (FS+TB+ES+WS). Duplication justified:
 ...
 * modules/accounting/shared/domain/money.utils.ts). D4 Option A, proposal #2315.
 */
