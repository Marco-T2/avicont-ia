 ...
 * Cycle 5 / IB (sdd/oleada-money-decimal-hex-purity).
 *
 * Sister of sub-POC 2 Cycles 1-4 (FS, TB, ES, WS). Asserts
 * `modules/accounting/initial-balance/domain/initial-balance.builder.ts` no
 ...
 *
 * Declared failure mode (pre-GREEN): both assertions FAIL — initial-balance.builder.ts
...
describe("sentinel: decimal.js import-shape — initial-balance/domain/initial-balance.builder (sub-POC 2 Cycle 5)", () => {
