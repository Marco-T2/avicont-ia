 ...
 *   consolidated into @/modules/accounting/shared/domain/money.utils; this
 *   module's money.utils is now a thin re-export shim)
...
describe("POC trial-balance-hex C0 — domain layer shape", () => {
  ...
  // This module's money.utils is now a thin re-export shim — identity preserved,
