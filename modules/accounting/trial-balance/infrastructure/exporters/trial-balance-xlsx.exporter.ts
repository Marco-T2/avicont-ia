 ...
 *
 * Self-contained: only exceljs + own domain types. No cross-module deps.
 * Lifted from features/accounting/trial-balance/exporters/trial-balance-xlsx.exporter.ts
 * as part of poc-accounting-trial-balance-hex (OLEADA 6).
 */
