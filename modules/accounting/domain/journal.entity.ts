...
export class Journal {
  ...
  private assertMutable(): void {
    ...
    // status (más conservador que legacy, que sólo verifica en POSTED). Razón:
    // auto-entries entran POSTED directo desde auto-entry-generator y nunca
    // pasan por DRAFT; el invariante del bookmark es "sourceType !== null →
    // reject" sin condicionar status, y la divergencia favorece safety.
    if (this.props.sourceType !== null) {
