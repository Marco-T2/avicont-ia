...
import {
  ...
  logDivergent,
  type SagaOperation,
} from "../domain/member-clerk-saga.logger";

/**
 * Generic saga helper for members <-> Clerk write operations.
 *
 * Scoped to members (design S2 -- explicit rejection of premature
 ...
 *
 * Invariants enforced by this single entry point (design S2):
