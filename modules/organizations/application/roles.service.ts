...
export class RolesService {
  ...
  private readonly permissionCache: PermissionCachePort;
  ...
  async createRole(
    ...
    this.permissionCache.revalidateOrgMatrix(orgId);
  ...
  async updateRole(
    ...
    if (callerRoleSlug !== null && callerRoleSlug === slug) {
      ...
      if (!postEditWrite.includes("members")) {
        throw new ForbiddenError(
          "No podes quitarte a vos mismo la gestion de miembros",
          SELF_LOCK_GUARD,
        );
      }
    }
