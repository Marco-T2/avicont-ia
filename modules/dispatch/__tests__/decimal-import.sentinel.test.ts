 ...
 * Cycle 3 / dispatch (sdd/oleada-money-decimal-hex-purity).
 *
 * Sister of sub-POC 3 Cycles 1-2 (sale, purchase) and sub-POC 2 Cycles 1-5.
 * Asserts `modules/dispatch/domain/compute-line-amounts.ts` no longer
 ...
 *
 * Declared failure mode (pre-GREEN): both assertions FAIL — compute-line-amounts.ts
...
describe("sentinel: decimal.js import-shape — dispatch/domain/compute-line-amounts (sub-POC 3 Cycle 3)", () => {
