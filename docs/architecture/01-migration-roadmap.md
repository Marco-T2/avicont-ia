...
| `poc-account-balances-hex` | `features/account-balances` | 150 | 0 | **7** | pending — paired POC #9 territory (circular dep w/ features/accounting via JournalEntryWithLines + LedgerService); consumer count corrected 2 → 7 (recon discovered) |
