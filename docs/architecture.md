...
| `PurchaseServiceForBridge` (inbound IVA→Purchase) | `features/purchase/purchase.service.ts` | `iva-books.service.ts:618 recomputeFromPurchaseCascade` | Mirror simétrico sale-side (§18.4 fila #11.0b A4 γ). Misma shape-dependency `externalTx`. |
